...
export default function Hero(){
  ...
  const toggleVideo = ()=>{
    ...
    return(
        <div className="px-3 pt-5 flex relative">
            <video 
            ref={videoRef}
            autoPlay
            playsInline
            ...
            >
             <source  src="https://res.cloudinary.com/dbdvicxun/video/upload/v1781599530/b_Animate_the_characte_online-video-cutter.com_fb230s.mp4" type="video/mp4"/>
            </video>
