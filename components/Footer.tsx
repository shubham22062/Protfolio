export default function Footer(){
    return(
        <div>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4 px-3 text-center">
                <span className="text-gray-400 text-sm sm:text-lg">Bulid by</span>
                <a href="https://www.linkedin.com/in/shubham-awasthi-310520291/?skipRedirect=true"
              target="_blank"
              rel="noopener noreferrer">
                    <span className="text-gray-400 text-sm sm:text-lg hover:underline hover:text-red-500">Shubham Awasthi.</span>
                </a>

                <span className="text-gray-400 text-sm sm:text-lg">Check out the source code on</span>
                <a href="https://github.com/shubham22062"
                target="_blank"
                rel="noopener noreferrer"
                >
                    <span className="text-gray-400 text-sm sm:text-lg hover:underline hover:text-red-500">Github</span>
                </a>
            </div>
