        ...
        <div className="flex justify-center md:justify-start">
          <motion.div
            ...
            className="
              ...
              md:w-[clamp(320px,43.478vw,600px)]
              md:ml-[clamp(16px,5.797vw,80px)]

              /* TABLET ONLY: 768px - 1023px */
              md:max-lg:w-[calc(50vw-70px)]
              md:max-lg:ml-[20px]
            "
          >
            {/* IBM LOGO */}
            ...
            <div className="rounded-2xl border-2 border-amber-50 bg-black/40 backdrop-blur-md p-4 sm:p-6 transition duration-300 hover:scale-105">
              ...
              <p className="mt-4 sm:mt-8 text-sm sm:text-base text-gray-400 leading-6 sm:leading-7">
                ...
                platform focused on promoting SDG-3 (Good Health & Well-being).
                I built an interactive user experience where health assessments
                and quizzes were used to analyze user needs and deliver
                personalized exercise plans, diet recommendations, and wellness
                resources. I also designed a responsive and accessible frontend
                using HTML, CSS, and JavaScript, ensuring a seamless user
                journey from assessment to actionable health insights while
                emphasizing clean UI and user-centric design.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="rounded-2xl border-2 border-amber-50 bg-black/40 backdrop-blur-md p-4 sm:p-6 transition duration-300 hover:scale-105">
              ...
              <p className="mt-4 sm:mt-8 text-sm sm:text-base text-gray-400 leading-6 sm:leading-7">
                ...
                security-focused web applications by developing both frontend
                and backend features. I worked with RESTful APIs and server-side
